...
void main() async {
  ...
  Gemini.init(apiKey: 'AIzaSyAjWuB8YIMHzu3BeNfoyQwF-NEfOgJcdEw');
  runApp(MyApp());
}
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ShadApp.material(
      title: 'Online code editor AI🪄',
      themeMode: ThemeMode.dark,
      home: BlocProvider(
        create: (context) => JudgeBloc()..add(LoadLanguages()),
        child: MyHomePage(),
      ),
    );
  }
...
''',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Online code editor AI🪄'),
      ),
      body: Padding(
